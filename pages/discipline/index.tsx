                    ...
                    <div className={styles.ContainerPreview}>
                        <fieldset className={styles.FieldsetPreview}>
                            <div className={styles.ImageContainerPreview}>
                                <img className={styles.ImagePreview} src={image || 'discipline-placeholder.png'}></img>
                            </div>
                            <label className={styles.LabelName}>{name || 'Disciplina'}</label>
                            <label className={styles.LabelDescription}>{description || 'Descrição'}</label>
                            <label className={styles.LabelLength}>{length || 'Tamanho'}</label>
                        </fieldset>
